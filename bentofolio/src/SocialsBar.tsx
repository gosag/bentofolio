...
function SocialBar() {
  return (
    ...
    >
      ...
      <Card className="w-16 h-16 lg:w-20 lg:h-20 shrink-0 rounded-2xl flex justify-center items-center border-zinc-200 bg-zinc-50 shadow-sm hover:shadow-md transition-shadow cursor-default">
        <motion.svg 
      ...
      <div className="flex flex-row flex-1 lg:flex-col lg:w-20 justify-around items-center p-2 lg:py-4 gap-4 bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-2xl shadow-sm">
